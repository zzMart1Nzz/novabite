<x-layouts.app :title="__('Dashboard')">
    <div class="rounded-2xl border border-zinc-200 p-6">
        ...
        <div class="mt-6 flex flex-wrap gap-3">
            ...
            <a href="{{ route('home', absolute: false) }}" class="inline-flex items-center justify-center rounded-xl border border-zinc-200 px-5 py-3 font-semibold hover:bg-zinc-50" wire:navigate>
                Webgunera itzuli
            </a>
        </div>
    </div>
